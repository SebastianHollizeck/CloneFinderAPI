...
#get the path of the dir in which the script is
...
if parser.parse() == False:
        ...
        while RepeatUnion=='y':
            ...
            if RmCloLs==[]:
                  ...
                  no_back_para_mut_decomposed_seq,Tree = DecomposedCloneSummary.fix_back_para_mut_decomposed(rename_seq_builder,tree_builder.mao_file)
