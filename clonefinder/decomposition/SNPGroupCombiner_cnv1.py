    ...
    def get_candidate_decomposed_clones(self, target_tumor):
        ...
        for Hit in HitCloCluLs:
            if HitCloCluLs[Hit] > 0.02:
                if (
                    Hit[: len(target_tumor + "Clu")] == target_tumor + "Clu"
                    and Hit.find("REP") == -1
                ):
                    SigCluLs.append(Hit)
                    ...
                    for CluN in Clu2center:
                        ...
                        if (
                            LarCen < Center2
                        ):  # and Sign=='Pos':  #Pos for middle cut, Neg for K-means
                            LarCen = Center2
                            if Center == Center2:
                                RootClu = target_tumor + CluN
                        elif (
                            LarCen <= Center2 and Sign == "Pos"
                        ):  # Pos for middle cut, Neg for K-means
                            LarCen = Center2
                            if Center == Center2:
                                RootClu = target_tumor + CluN
        ...
        if RootClu != "" or CluCombLs != {}:
                        ...
                        if Go == "y":
                            ...
                            if Redun_ls == []:
                                CloCan2Seq[
                                    "#"
                                    + target_tumor
                                    + Root.replace(target_tumor + "Clu", "Clu")
                                    + CluN
                                ] = Seq
                                Got_Candidate = "y"
            ...
            if Got_Candidate == "y":
                ...
                Clone2Freq = clone_frequency.do_nnls0(
                    Cmatrix_noCNV, Can_list, alt_frequency
                )
                ...
                for Clo0 in Clone2Freq:
                    ...
                    if Clone2Freq[Clo0] > 0.02:
                        ...
                        for Mut in SeqMutPos:
                            if TuMatPosi.count(Mut) != 0:
                                AllMut.append(Mut)
                        for Mut in TuMatPosi:
                            if SeqMutPos.count(Mut) == 0:
                                TuSeq = "n"
                        Iden = "n"
                        ...
                        if Iden != "n":
                            ...
                            out2 += [
                                "#"
                                + Clo0.replace(
                                    target_tumor + target_tumor, target_tumor
                                ),
                                CloCan2Seq["#" + Clo0],
                            ]
                            if Clo0.find("Clu") != -1 and Clo0.find("REP") == -1:
                                CluHit = "y"
                        else:
